  ...
  const experiences = [
    {
      ...
      period: '2023 – Present',
      description: [
        'Build and maintain production healthcare web applications using Vue.js, PHP, and Laravel',
        'Develop and maintain frontend features using Vue.js with Tailwind CSS for responsive UI',
        'Build backend APIs and business logic using PHP and Laravel framework',
        'Design and optimize MySQL databases for healthcare data management',
        'Develop frontend features for AI-powered healthcare cost calculator',
        'Maintain internal management system workflows for operations and administration',
        'Automate patient journey workflows to reduce manual operational steps',
        'Support staff with laptop setup, Microsoft 365 onboarding, and IT troubleshooting',
      ],
    },
    {
